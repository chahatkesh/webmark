    ...
    <div className="relative pt-12 md:pt-20">
      <div className="pl-4 pr-4 sm:pl-6 sm:pr-6 max-w-[72rem] ml-auto mr-auto">
        <div className="max-w-[48rem] text-center ml-auto mr-auto">
          <h2 className="md:leading-[1.2777] leading-[1.3333] text-[0.875rem] tracking-[-0.037em] md:text-[2.25rem] font-[700]">
            Trusted and loved by Professionals
          </h2>
        </div>
      </div>
      <div className="flex relative max-w-[100vw] justify-center ml-auto mr-auto">
        ...
        <div className="testimonial w-full pt-12 pb-12 md:pt-20 md:pb-20 inline-flex flex-nowrap justify-start">
          ...
          <div
            aria-hidden="true"
            className="testimonial-list flex items-start justify-center md:justify-start">
            {/* item 1 */}
            <article className="rotate-[-1deg] ml-3 mr-3 shadow p-5 bg-[#ffffffb3] rounded-2xl flex flex-col w-[22rem] relative">
              <header className="flex items-center mb-4 gap-3">
                <img
