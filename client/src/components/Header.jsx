      ...
      <nav className="hidden md:flex text-[#374252]">
        <ul className="flex flex-grow flex-wrap justify-center items-center gap-4 lg:gap-8 text-sm">
          <li
            ...
            className={
              isActive("dashboard")
                ? "bg-gray-50 text-black font-[500] cursor-pointer rounded pt-1 pb-1 pl-3 pr-3"
                : "cursor-pointer hover:bg-gray-50 hover:text-black rounded pt-1 pb-1 pl-3 pr-3"
            }>
            dashboard
          </li>
          <li
            onClick={() => navigate("/user/more-tools")}
            className={
              isActive("more-tools")
                ? "bg-gray-50 text-black font-[500] cursor-pointer rounded pt-1 pb-1 pl-3 pr-3"
                : "cursor-pointer hover:bg-gray-50 hover:text-black rounded pt-1 pb-1 pl-3 pr-3"
          ...
          <li
            onClick={() => navigate("/user/how-to-use")}
            className={
              isActive("how-to-use")
                ? "bg-gray-50 text-black font-[500] cursor-pointer rounded pt-1 pb-1 pl-3 pr-3"
                : "cursor-pointer hover:bg-gray-50 hover:text-black rounded pt-1 pb-1 pl-3 pr-3"
