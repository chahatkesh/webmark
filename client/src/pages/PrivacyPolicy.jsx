        ...
        <div className="bg-white shadow rounded-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="text-gray-700 mb-4">
              At Webmark, we value your privacy and are committed to protecting
              your personal information. This Privacy Policy explains how we
              collect, use, and safeguard your data when you use our bookmark
              management service.
            </p>
            ...
            <ul className="list-disc pl-8 mb-4 text-gray-700">
              ...
              <li>
                ...
                you interact with our Service, including device information, IP
            ...
            <p className="text-gray-700 mb-4">
              ...
              our data practices, please contact us at privacy@webmark.com.
            </p>
          </div>
        </div>
