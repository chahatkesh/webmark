...
const PAGE_DESCRIPTIONS = {
  ...
  Features:
    "Discover powerful features of Webmark: custom categorization, instant search, cloud sync, and more. The modern solution for bookmark management.",
  About:
    "Learn about Webmark's mission to simplify digital organization. Our team is dedicated to creating the most user-friendly bookmark management experience.",
  Privacy:
    "Read Webmark's privacy policy. We respect your data and are committed to transparency in how we collect, use, and protect your information.",
  Terms:
    "Webmark terms of service and conditions. Learn about the rules and guidelines governing the use of our bookmark management platform.",
  ...
  Onboarding:
    "Get started with Webmark in minutes. Our simple onboarding process will have you organizing your bookmarks efficiently in no time.",
  Contact:
    "Connect with the Webmark team for support, feedback, or partnership opportunities. We're here to help with your bookmark management needs.",
  Report:
    "Report technical issues or suggest improvements for Webmark. Help us make the best bookmark management platform for everyone.",

  // Features-specific pages
  BookmarkManagement:
    "Organize your bookmarks with Webmark's intuitive management system. Add, edit, and delete bookmarks with ease.",
  Categorization:
    "Create custom categories and folders in Webmark to organize your bookmarks exactly the way you want them.",
  Search:
    "Find any bookmark instantly with Webmark's powerful search functionality. Filter by title, tags, categories, and more.",
  Sync: "Keep your bookmarks synchronized across all your devices with Webmark's seamless cloud synchronization.",
  Dashboard:
    "View and manage all your bookmarks from Webmark's clean, intuitive dashboard. See statistics and usage patterns at a glance.",

  // FAQ sections
  GeneralFAQ:
    "General questions about Webmark bookmark management platform. Learn about our service, features, and capabilities.",
  AccountFAQ:
    "Account management FAQs for Webmark users. Find help with registration, login, password recovery, and account settings.",
  BookmarkFAQ:
    "Bookmark-related FAQs for Webmark users. Learn how to add, organize, tag, and manage your bookmarks effectively.",
  PrivacyFAQ:
    "Privacy and security FAQs for Webmark. Learn how we protect your data and keep your bookmarks secure.",
  TroubleshootingFAQ:
    "Troubleshooting guides for common Webmark issues. Get help with technical problems and find quick solutions.",
};
  ...
  try {
    ...
    if (content.includes("<SEO")) {
      ...
      if (content.match(/description=["'].*?["']/)) {
        ...
        content = content.replace(/<SEO/, `<SEO description="${description}"`);
      }
    } else {
  ...
  try {
    ...
    for (const file of pageFiles) {
      if (file.endsWith(".jsx")) {
        ...
        else if (baseName.includes("NotFound"))
          continue; // Skip 404 page
